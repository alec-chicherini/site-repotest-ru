...
int main() {
	...
	main << (HTML::Table().cls("table table-hover table-sm")
		...
		<< (HTML::Row() << (HTML::Col() << HTML::Link("repotest.ru", "https://repotest.ru/index.html"))
			<< (HTML::Col() << HTML::Link("pet-projects-production", "https://github.com/alec-chicherini/pet-projects-production"))
			<< HTML::Col("Логика деплоя этого сайта")
			<< (HTML::Col() << HTML::Link("https://www.docker.com/", "https://www.docker.com/")))
		<< (HTML::Row() << (HTML::Col() << HTML::Link("repotest.ru", "https://repotest.ru/index.html"))
			<< (HTML::Col() << HTML::Link("site-repotest-ru", "https://github.com/alec-chicherini/site-repotest-ru"))
			<< HTML::Col("Этот сайт")
			<< (HTML::Col() << HTML::Link("https://github.com/SRombauts/HtmlBuilder", "https://github.com/SRombauts/HtmlBuilder")))
		<< (HTML::Row() << (HTML::Col() << HTML::Link("repotest.ru", "https://repotest.ru/index.html"))
			<< (HTML::Col() << HTML::Link("server-http", "https://github.com/alec-chicherini/server-http"))
			<< HTML::Col("HTTP сервер")
			<< (HTML::Col() << HTML::Link("userver", "https://userver.tech/")))
		<< (HTML::Row() << (HTML::Col() << HTML::Link("wordle-client-qt.repotest.ru", "https://wordle-client-qt.repotest.ru/wordle-client-qt.html"))
			<< (HTML::Col() << HTML::Link("wordle-client-qt", "https://github.com/alec-chicherini/wordle-client-qt"))
